...
class Usuarios extends Controllers
{
	...
	public function Usuarios()
	{
		...
		$data['page_title'] = "USUARIOS <small>Softrans</small>";
	...
	public function getUsuarios()
	{
		if ($_SESSION['permisosMod']['r']) {
			...
			for ($i = 0; $i < count($arrData); $i++) {
				...
				if ($_SESSION['permisosMod']['r']) {
					$btnView = '<button class="btn btn-secondary btn-sm btnViewUsuario" onClick="fntViewUsuario(' . $arrData[$i]['idpersona'] . ')" title="Ver usuario"><i class="far fa-eye"></i></button>';
				}
				if ($_SESSION['permisosMod']['u']) {
