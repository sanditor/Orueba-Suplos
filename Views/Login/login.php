      ...
      <div class="login-box">
        ...
        <form class="login-form" name="formLogin" id="formLogin" action="">
          ...
          <div class="form-group">
            ...
            <input id="txtEmail" name="txtEmail" class="form-control" type="email" placeholder="email usuario" autofocus>
            <span class="text-danger">Administrador: admin@admin.com</span><br />
            <span class="text-danger">Cliente: cliente@cliente.com</span>
          </div>
          <div class="form-group">
            <label class="control-label">CONTRASEÑA</label>
            <input id="txtPassword" name="txtPassword" class="form-control" type="password" placeholder="contraseña usuario">
            <span class="text-danger">Password: 123456</span>
          </div>
          <div class="form-group">
            <div class="utility">
